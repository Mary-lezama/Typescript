...
function consulta1() {
    return new Promise(resolve => setTimeout(() => resolve ("Consulta al psicologo"), 5000));
}

function consulta2() {
    return new Promise(resolve => setTimeout(() => resolve ("Consulta al Pediatra"), 8000));
}

function consulta3() {
    return new Promise(resolve => setTimeout(() => resolve ("Consulta al Neurologo"), 2000));
}
...
async function consultas() {
    try {
        ...
        const resultados = await Promise.all([co1,co2,co3]);
        console.log("Consultas disponible:", resultados);
    } catch (error) {
